...
const T = {
  en: {
    ...
    faq: [
      ...
      ['Do you guarantee AI will recommend me?', "No, and nobody honestly can. We measure how AI recommends restaurants today, explain why, and show what to improve. It is measurement, not guaranteed rankings."],
      ['Can AI answers change over time?', "They can and do. That is why we measure across multiple prompts and models and treat results as a snapshot — and why monthly monitoring is on the way."],
