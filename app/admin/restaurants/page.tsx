...
import { UtensilsCrossed, Search, Plus, PlayCircle, ExternalLink } from 'lucide-react'
  ...
  return (
    <div className="p-8 max-w-6xl mx-auto">
      ...
      <div className="relative mb-5">
        ...
        <input
          type="text"
          placeholder="Search by name, city, email, website…"
          value={search}
      ...
      <Card>
        {loading ? (
          ...
          <EmptyState
            ...
            description={search ? 'Try a different search term' : 'Upload a CSV to get started'}
          />
        ) : (
          <>
                    ...
                    <tr key={r.id} className="hover:bg-gray-50 transition-colors">
                      ...
                      <td className="px-5 py-3 text-right">
                        <Button
                          variant="ghost"
                          size="sm"
                          onClick={() => triggerAudit(r.id, r.name)}
                          disabled={auditingId === r.id}
                        >
                          {auditingId === r.id ? (
